    ...
    await Promise.all([
      ...
      prisma.manualAsset.create({
        data: {
          ...
          metadata: { category: 'lithograph', year: 1944, condition: 'excellent', authenticity: 'verified', collectible: { category: 'art', provider: 'artsy', externalId: 'frida-kahlo-self-portrait-litho-23', valuationEnabled: true, lastProviderSync: new Date(Date.now() - 2 * 86400000).toISOString() }, documents: [{ key: 'frida-certificate.pdf', name: 'Certificate of Authenticity', type: 'application/pdf', size: 310000, uploadedAt: '2019-12-01' }] },
        },
      }),
      prisma.manualAsset.create({
        data: {
          ...
          metadata: { category: 'metaverse_land', platform: 'The Sandbox', coordinates: '(-12, 45)', size: '3x3', documents: [{ key: 'sandbox-land-receipt.png', name: 'Blockchain Receipt', type: 'image/png', size: 65000, uploadedAt: '2022-01-15' }] },
        },
      }),
      prisma.manualAsset.create({
        data: {
          ...
          metadata: { category: 'nft', collection: 'Bored Ape Yacht Club', tokenId: 7291, blockchain: 'ethereum', documents: [{ key: 'bayc-provenance.pdf', name: 'OpenSea Provenance', type: 'application/pdf', size: 72000, uploadedAt: '2021-08-10' }] },
        },
      }),
      prisma.manualAsset.create({
        data: {
          ...
          metadata: { category: 'nft_wearable', platform: 'Decentraland', items: 12, documents: [{ key: 'dcl-wearables-inventory.pdf', name: 'Wearables Inventory', type: 'application/pdf', size: 48000, uploadedAt: '2022-05-20' }] },
        },
      }),
      prisma.manualAsset.create({
        data: {
          ...
          acquisitionCost: 800,
          metadata: { domain: 'diegonavarro.eth', registrar: 'ENS', expiryDate: '2026-12-01', documents: [{ key: 'ens-registration.png', name: 'Registration Receipt', type: 'image/png', size: 35000, uploadedAt: '2021-12-01' }] },
        },
      }),
    ]);
  ...
  const [patriciaAngel, patriciaJewelry, carlosJewelry, diegoSandboxPortfolio] = await Promise.all([
    prisma.manualAsset.create({
      data: {
        ...
        acquisitionCost: 50000,
        metadata: { companyName: 'PayLatam', round: 'Series A', equity: '0.5%', sector: 'fintech', stage: 'growth', documents: [{ key: 'paylatam-safe.pdf', name: 'SAFE Agreement', type: 'application/pdf', size: 280000, uploadedAt: '2023-03-15' }, { key: 'paylatam-cap-table.pdf', name: 'Cap Table', type: 'application/pdf', size: 95000, uploadedAt: '2023-03-20' }] },
      },
    }),
    prisma.manualAsset.create({
      data: {
        ...
        metadata: { items: 8, lastAppraisal: '2024-11-15', appraiser: 'Christie\'s México', insured: true, documents: [{ key: 'jewelry-appraisal-2024.pdf', name: 'Appraisal Report', type: 'application/pdf', size: 420000, uploadedAt: '2024-11-15' }, { key: 'jewelry-insurance.pdf', name: 'Insurance Certificate', type: 'application/pdf', size: 180000, uploadedAt: '2024-12-01' }] },
      },
    }),
    prisma.manualAsset.create({
      data: {
        ...
        metadata: { items: 3, watches: ['Rolex Submariner', 'Omega Speedmaster', 'TAG Heuer Carrera'], insured: true, documents: [{ key: 'watch-collection-appraisal.pdf', name: 'Collection Appraisal', type: 'application/pdf', size: 190000, uploadedAt: '2024-06-01' }] },
      },
    }),
    prisma.manualAsset.create({
      data: {
        ...
        acquisitionDate: new Date('2022-01-15'),
        acquisitionCost: 12000,
        metadata: { category: 'virtual_real_estate', platform: 'The Sandbox', totalParcels: 5, totalSize: '7 plots', documents: [{ key: 'sandbox-portfolio-summary.pdf', name: 'Portfolio Summary', type: 'application/pdf', size: 110000, uploadedAt: '2024-06-15' }] },
      },
    }),
  ]);
  ...
  const [patriciaPenthouse, patriciaLifeInsurance, patricia529, patriciaAnnuity] = await Promise.all([
    ...
    prisma.manualAsset.create({
      data: {
        ...
        acquisitionCost: 0,
        metadata: { provider: 'MetLife', policyType: 'term_life', termYears: 20, faceValue: 500000, annualPremium: 1200, beneficiary: 'Carlos Mendoza', documents: [{ key: 'metlife-policy.pdf', name: 'Policy Document', type: 'application/pdf', size: 450000, uploadedAt: '2020-02-01' }] },
      },
    }),
    prisma.manualAsset.create({
      data: {
        ...
        metadata: { provider: 'Vanguard', planType: '529', beneficiary: 'Sofia Ruiz', state: 'Nevada', portfolio: 'Age-Based Aggressive', documents: [{ key: '529-beneficiary-form.pdf', name: 'Beneficiary Form', type: 'application/pdf', size: 120000, uploadedAt: '2018-09-15' }] },
      },
    }),
    prisma.manualAsset.create({
      data: {
        ...
        metadata: { provider: 'TIAA', annuityType: 'fixed', guaranteedRate: 3.5, payoutStart: '2035-01-01', documents: [{ key: 'tiaa-contract.pdf', name: 'Annuity Contract', type: 'application/pdf', size: 380000, uploadedAt: '2017-06-15' }] },
      },
    }),
  ]);
  ...
  const [carlosBeetle, carlosWine, carlosRolex] = await Promise.all([
    ...
    prisma.manualAsset.create({
      data: {
        ...
        acquisitionCost: 32000,
        metadata: { bottles: 24, regions: ['Napa Valley', 'Rioja'], topBottles: ['Opus One 2018', 'Vega Sicilia Unico 2012'], insured: true, storageLocation: 'Climate-controlled cellar', collectible: { category: 'wine', provider: 'wine-searcher', externalId: 'collection-carlos-24', valuationEnabled: true, lastProviderSync: new Date(Date.now() - 5 * 86400000).toISOString() }, documents: [{ key: 'wine-insurance.pdf', name: 'Insurance Certificate', type: 'application/pdf', size: 150000, uploadedAt: '2024-02-10' }] },
      },
    }),
    prisma.manualAsset.create({
      data: {
  ...
  const [mariaSneaker, carlosSneaker] = await Promise.all([
    prisma.manualAsset.create({
      data: {
        ...
        acquisitionCost: 110,
        metadata: { collectible: { category: 'sneaker', provider: 'sneaks', externalId: 'CW2288-111', valuationEnabled: true, lastProviderSync: new Date().toISOString() }, documents: [{ key: 'af1-receipt.pdf', name: 'Purchase Receipt', type: 'application/pdf', size: 32000, uploadedAt: '2024-06-01' }] },
      },
    }),
    prisma.manualAsset.create({
      data: {
  ...
  const [carlosCoin, diegoCard] = await Promise.all([
    prisma.manualAsset.create({
      data: {
        ...
        metadata: { collectible: { category: 'coin', provider: 'pcgs', externalId: 'cert-12345678', valuationEnabled: true, lastProviderSync: new Date(Date.now() - 4 * 86400000).toISOString() }, grade: 'MS-63', mintage: 100000, composition: '90% silver', documents: [{ key: 'pcgs-cert-12345678.pdf', name: 'PCGS Certificate', type: 'application/pdf', size: 95000, uploadedAt: '2022-11-10' }] },
      },
    }),
    prisma.manualAsset.create({
      data: {
        ...
        metadata: { collectible: { category: 'card', provider: 'psa', externalId: 'cert-87654321', valuationEnabled: true, lastProviderSync: new Date(Date.now() - 2 * 86400000).toISOString() }, grade: 'PSA 10 Gem Mint', set: 'Base Set 1st Edition', cardNumber: '4/102', documents: [{ key: 'psa-cert-87654321.pdf', name: 'PSA Certificate', type: 'application/pdf', size: 88000, uploadedAt: '2023-05-20' }] },
      },
    }),
  ]);
