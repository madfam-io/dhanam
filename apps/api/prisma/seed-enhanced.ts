...
async function main() {
  ...
  console.log('  - 1 Web3/Metaverse user (Diego) with NFTs and metaverse assets');
  console.log('  - 1 Platform admin');
  console.log('  - 6 Spaces with budgets');
  console.log('  - 25 Connected accounts');
  console.log('  - 8 Manual assets with valuation history');
  ...
  console.log('  - 2,000+ Transactions');
