...
describe('TransactionItem', () => {
  it('should render transaction description', () => {
    const { getByText } = render(
      <TransactionItem transaction={mockTransaction as any} />,
    );
  ...
  it('should render "Uncategorized" when no category', () => {
    ...
    const { getByText } = render(
      <TransactionItem transaction={noCategoryTxn as any} />,
    );
  ...
  it('should show "Pending" chip for pending transactions', () => {
    ...
    const { getByText } = render(
      <TransactionItem transaction={pendingTxn as any} />,
    );
  ...
  it('should show + prefix for income transactions', () => {
    ...
    const { getByText } = render(
      <TransactionItem transaction={incomeTxn as any} />,
    );
