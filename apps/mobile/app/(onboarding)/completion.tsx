      ...
      >
        ...
        <View style={{ 
          ...
          <View style={{ flexDirection: 'row', flexWrap: 'wrap' }}>
            {[
              { num: '1', title: 'Explora tu Dashboard', desc: 'Ve un resumen completo de tu situación financiera' },
              { num: '2', title: 'Conecta tus cuentas', desc: 'Vincula bancos y wallets para sincronización automática' },
              { num: '3', title: 'Crea presupuestos', desc: 'Establece límites de gasto y recibe alertas automáticas' },
              { num: '4', title: 'Analiza ESG', desc: 'Revisa el impacto ambiental de tus inversiones crypto' }
            ].map((item, index) => (
