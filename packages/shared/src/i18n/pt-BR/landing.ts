export const landing = {
  ...
  pricing: {
    ...
    community: {
      ...
      features: [
        '1 espaço pessoal',
        'Apenas contas manuais (sem conexões com provedores)',
        '2 simulações por dia',
        '5 cálculos ESG por dia',
        'Orçamentos e categorização básica',
        'Histórico de transações e busca',
      ],
    ...
    selfHosted: 'Procurando auto-hospedagem? Edição comunitária',
  },
  problemSolution: {
