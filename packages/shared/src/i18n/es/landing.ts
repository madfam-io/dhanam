export const landing = {
  ...
  pricing: {
    ...
    community: {
      ...
      features: [
        '1 espacio personal',
        'Solo cuentas manuales (sin conexiones a proveedores)',
        '2 simulaciones por día',
        '5 cálculos ESG por día',
        'Presupuestos y categorización básica',
        'Historial de transacciones y búsqueda',
      ],
    ...
    selfHosted: '¿Buscas auto-hospedaje? Edición comunitaria',
  },
  problemSolution: {
