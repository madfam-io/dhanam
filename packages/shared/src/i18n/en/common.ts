...
export const common = {
  ...
  // Demo personas
  demoTitle: 'Experience Dhanam',
  demoSubtitle: 'Pick a financial life to explore. Switch personas anytime from the dashboard.',
  demoExploreAs: 'Explore as',
  demoQuickStart: 'Quick Start',
  demoSwitchPersona: 'Switch persona',
