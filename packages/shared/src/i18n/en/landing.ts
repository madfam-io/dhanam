export const landing = {
  ...
  pricing: {
    ...
    community: {
      ...
      features: [
        '1 personal space',
        'Manual accounts only (no provider connections)',
        '2 simulations per day',
        '5 ESG calculations per day',
        'Basic budgeting & categorization',
    ...
    essentials: {
      ...
      features: [
        ...
        '3 provider connections (Belvo + Bitso)',
    ...
    pro: {
      ...
      features: [
        ...
        'Collectibles valuation (7 categories)',
        'Document vault',
        'AI search (⌘K)',
        'Achievement system',
    ...
    premium: {
      ...
      features: [
        ...
        '24 historical stress scenarios',
    ...
    selfHosted: 'Looking for self-hosted? Community edition',
  },
  problemSolution: {
